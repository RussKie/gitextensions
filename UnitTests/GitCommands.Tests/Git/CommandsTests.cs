...
namespace GitCommandsTests_Git
{
    ...
    public partial class CommandsTests
    {
        ...
        [TestCase(false, false, false, false, false, false, null, "from", "onto", "-c rebase.autoSquash=false rebase \"from\" \"branch\" --onto onto")]
        [TestCase(false, false, false, false, true, false, null, "from", "onto", "-c rebase.autoSquash=false rebase --ignore-date \"from\" \"branch\" --onto onto")]
