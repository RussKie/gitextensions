...
namespace GitUI.CommandsDialogs
{
    ...
    /// </summary>
    internal class RepoBrowserMenus : ITranslate, IDisposable
    {
        private readonly RepoBrowser _owner;
        ...
        public RepoBrowserMenus(RepoBrowser owner, ToolStrip menuStrip)
        {
            _owner = owner;
        ...
        public void InsertRevisionGridMainMenuItems(ToolStripItem insertAfterMenuItem)
        {
            ...
            SetDropDownItems(_owner.navigateToolStripMenuItem, _navigateMenuCommands);
            SetDropDownItems(_owner.viewToolStripMenuItem, _viewMenuCommands);
            ...
            {
                _owner.viewToolStripMenuItem.DropDownItems.Add(new ToolStripSeparator());
                _owner.viewToolStripMenuItem.DropDownItems.Add(_toolbarsMenuItem);
            }
        ...
        {
            foreach (ToolStripMenuItem? menuItem in new[] { _toolbarsMenuItem })
            {
